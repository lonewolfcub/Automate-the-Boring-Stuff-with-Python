...
# sendDuesReminders.py - Sends emails based on payment status in a spreadsheet.
...
smtpObj.ehlo()
smtpObj.starttls()
smtpObj.login('codenoob.ts@gmail.com', sys.argv[1])
...
for name, email in unpaidMembers.items():
    ...
    sendmailStatus = smtpObj.sendmail('codenoob.ts@gmail.com', email, body)
